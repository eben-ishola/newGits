...
let AuthController = class AuthController {
    ...
    async login(payload) {
        ...
        return await this.authService.signIn(identifier, payload.password);
    }
    async changePassword(body, user) {
        const userId = user?._id ?? user?.id;
        return this.authService.changePassword(userId ? String(userId) : undefined, body?.currentPassword, body?.newPassword);
    }
