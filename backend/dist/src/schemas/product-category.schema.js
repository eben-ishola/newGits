...
], ProductCategory.prototype, "dailyMobilization", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], ProductCategory.prototype, "percentageContribution", void 0);
exports.ProductCategory = ProductCategory = __decorate([
    (0, mongoose_1.Schema)({ collection: 'productcategories' })
], ProductCategory);
